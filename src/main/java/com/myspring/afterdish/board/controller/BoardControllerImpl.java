...
public class BoardControllerImpl implements BoardController{
	...
	@Override
	@RequestMapping(value="/goods/viewGoods.do",method = {RequestMethod.GET,RequestMethod.POST})
	public ModelAndView viewGoods(HttpServletRequest request,HttpServletResponse response)throws Exception{
		String viewName = (String)request.getAttribute("viewName");
		System.out.println("제품페이지 입성");
		ModelAndView mav = new ModelAndView(viewName);
		return mav;
	}
